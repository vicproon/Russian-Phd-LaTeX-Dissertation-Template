...
{\texorpdfstring{\MakeUppercase{Алгебраические методы реконструкции в плоской задаче компьютерной томографии для  Итерационные методы реконструкции измерений в задаче компьютерной томографии}}{Итерационные методы реконструкции измерений в задаче компьютерной томографии}}
