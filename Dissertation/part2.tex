...
Результаты восстановления с помощью решения задачи (\ref{eq:quadprog_eq}) представлены на рисунке \ref{im:quadprog}в,г.
...
\section{Продолжение результата на изображения больших размерностей}
...
На рис.\ref{fig:qp_phantom_64by64}а) видна цепочка из трех низкопоглощаюзих сегментов (зубов), в среднем из которых присутствует золотое включение.
Параметры гамма-коррекции подобраны таким образом, чтобы слабо поглощающее включение было контрастно видно на фоне яркого сильно поглощающего.
