...
Будем считать, что объект состоит из $K$ элементов, с неизвестными пространственными концентрациями $c_k(x,y)$, и известными табулированными спектральными функциями поглощения $\kappa_k(\lambda)$.
Тогда
$$
...
\vspace{-0.5cm}
\centering
\includegraphics[width=0.9\textwidth]{0999}
\vspace{-1cm}
фантом на тривиальных спектрах
\end{frame}
...
\vspace{-0.5cm}
\centering
\includegraphics[width=0.9\textwidth]{whiterec_res}
\vspace{-1cm}
Метод взвешенных невязок + метод барьерных функуий + мультипликативная регуляризация
\end{frame}
