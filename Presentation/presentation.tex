...
\begin{enumerate}
  ...
  \item Доказана сходимость предложенного метода. 
  ...
  \item Предложен алгебраический метод реконструкции для случая полихроматического зондирования, который позволяет оценить пространственное распределение концентраций разных элементов в зондируемом объеме. Математическая модель формирования томографической проекции, используемая на шаге прямого проецирования, включает линейную комбинацию концентраций.
\end{enumerate}
}
\end{frame}
\endgroup
